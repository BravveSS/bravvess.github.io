...
<main class="page" id="appRoot">
  ...
  <section class="panel-grid" data-owner-block>
...
<script>
/* =============== CONFIG PASSWORDS =============== */
const ADMIN_HASH = "8d1a714fdc290c65b183a88f7d3b474634579ac6b73b8cdaf704490049591484"; // (sha256 de tu clave admin previa)
const OWNER_PASSWORD = "BestOwner2025"; // <- CAMBIA ESTO SI QUIERES OTRA CONTRASEÑA FIJA
